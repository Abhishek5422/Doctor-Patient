		...
		<div class="header_agileinfo">
						<div class="w3_agileits_header_text">
							<ul class="top_agile_w3l_info_icons">
									<li><i class="fa fa-home" aria-hidden="true"></i>2nd Floor, Kuriland Tower, Marar Rd, Thrissur, Kerala 680001</li>
									<li class="second"><i class="fa fa-phone" aria-hidden="true"></i>085890 12025</li>
									
									<li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:maria@example.com">info@atees.com</a></li>
								</ul>
			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					...
					<ul id="m_nav_list" class="m_nav menu__list">
						...
						<li class="m_nav_item menu__item menu__item--current" id="moble_nav_item_2"> <a href="../Patient/about.php" class="menu__link"> About Us </a> </li>		
...
<!-- about -->
	<div class="about" id="about">
		<div class="container">
			...
			<p class="ab">Let the pain itself be great, the adipiscing elite will be followed. At the time of placing the boat. It is not now, the price of the protein is made in, the manufacturer needs the developer. The customer is very happy</p>
			 ...
			 <div class="about-w3lsrow"> 
				...
				<div class="col-md-6 col-sm-7 w3about-img"> 
					<div class="w3about-text"> 
						...
						<p>The customer is very important, the customer will be followed by the customer. At the time of placing the boat. It is not now, the price of the protein is made in, the manufacturer needs the developer. The customer is very happy</p>
...
<h3 class="w3_heade_tittle_agile"></h3>
		...
		<div class="container">
			...
			<div class="agile_footer_copy">
				<div class="w3agile_footer_grids">
					<div class="col-md-4 w3agile_footer_grid">
						<h3>About Us</h3>
						<p>The customer is very important, the customer will be followed by the customer. At the time of placing the boat. It is not now, the price of the protein is made in, the manufacturer needs the developer. The customer is very happy</span></p>
					</div>
					<div class="col-md-4 w3agile_footer_grid">
						<h3>Contact Info</h3>
						<ul>
			...
			<div class="w3_agileits_copy_right_social">
				<div class="col-md-6 agileits_w3layouts_copy_right">
					<p>@ 2023 Doctor Patient Appoinment | CORE PHP | <a href="https://atees.in/">ATEES Infomedia Pvt Ltd</a></p>
				</div>
