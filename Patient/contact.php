               ...
               <div class="col-md-4 contact-grid ">
					<div class="contact-grid1 agileits-w3layouts">
						...
						<div class="con-w3l-info">
						   <h4>Address </h4>
						  <p>2nd Floor, Kuriland Tower, Marar Rd<span>Thrissur, Kerala 680001</span></p>
						</div>
						<div class="clearfix"></div>
					</div>
				</div>
				<div class="col-md-4 contact-grid">
					<div class="contact-grid2 w3">
						...
						<div class="con-w3l-info">
						  <h4>Call Us</h4>
						   <p> 085890 12025<span> 085890 23136</span></p>
						</div>
						<div class="clearfix"></div>
					</div>
				</div>
		...
		<div class="container">
			...
			<div class="w3_agileits_copy_right_social">
				<div class="col-md-6 agileits_w3layouts_copy_right">
					<p>@ 2023 Doctor Patient Appoinment | CORE PHP  <a href="https://atees.org/">ATEES Industrial Training Pvt Ltd</a></p>
				</div>
