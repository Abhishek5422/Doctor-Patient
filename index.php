...
<!-- //for-meta-tags-->
<link href="Patient/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<link rel="stylesheet" href="Patient/css/flexslider.css" type="text/css" media="screen" Department="" />
<link href="Patient/css/services.css" rel="stylesheet" type="text/css" media="all" />
<link href="Patient/css/ziehharmonika.css" rel="stylesheet" type="text/css">
<link href="Patient/css/JiSlider.css" rel="stylesheet"> 
<link href="Patient/css/style.css" rel="stylesheet" type="text/css" media="all" />
<!-- font-awesome icons -->
<link href="Patient/css/font-awesome.css" rel="stylesheet"> 
<!-- //font-awesome icons -->
<link href="Patient///fonts.googleapis.com/css?family=Raleway:200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800" rel="stylesheet">
...
<!-- banner -->
 ...
 <div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					...
					<ul id="m_nav_list" class="m_nav menu__list">
						...
						<li class="m_nav_item menu__item" id="moble_nav_item_2"> <a href="Patient/about.php" class="menu__link"> About Us </a> </li>		
						<li class="m_nav_item menu__item" id="moble_nav_item_4"> <a href="Patient/contact.php" class="menu__link">Contact</a> </li>
						<li class="m_nav_item menu__item" id="moble_nav_item_3 dropdown"> <a href="#" class="menu__link dropdown-toggle" data-toggle="dropdown">Sign In <b class="caret"></b></a> 
						   <ul class="dropdown-menu agile_short_dropdown">
									<li><a href="Hospital/login.php">Hospital</a></li>
									<li><a href="Patient/Patient_login.php">Patient</a></li>
								</ul>
						</li>
			...
			<p class="ab">Lorem ipsum dolor sit amet, consectetur adipiscing elit.Sed blandit massa vel mauris sollicitudin dignissim.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus at placerat ante. Praesent nulla nunc, pretium dapibus efficitur in, auctor eget elit. Lorem ipsum dolor sit amet</p>
			 ...
			 <div class="about-w3lsrow"> 
				...
				<div class="col-md-6 w3about-img"> 
				    <img src="Patient/images/about.jpg" alt=" " class="img-responsive">
				</div> 
	...
	<div class="Department_girds_agileits">
		<div class="agile_team_grid">	
					...
					<div class="col-md-3 w3ls_banner_bottom_grid">
						<img src="Patient/images/g1.jpg" alt=" " class="img-responsive" />
						<div class="overlay">
							<h4>Department 1</h4>
					...
					<div class="col-md-3 w3ls_banner_bottom_grid">
						<img src="Patient/images/g2.jpg" alt=" " class="img-responsive" />
						<div class="overlay">
							<h4>Department 2</h4>
							<ul class="social_agileinfo">
								<li><a href="#" class="w3_facebook"><i class="fa fa-facebook"></i></a></li>
					...
					<div class="col-md-3 w3ls_banner_bottom_grid hvr-shutter-in-horizontal">
						<img src="Patient/images/g3.jpg" alt=" " class="img-responsive" />
						<div class="overlay">
							<h4>Department 3</h4>
							<ul class="social_agileinfo">
								<li><a href="#" class="w3_facebook"><i class="fa fa-facebook"></i></a></li>
					...
					<div class="col-md-3 w3ls_banner_bottom_grid">
						<img src="Patient/images/g4.jpg" alt=" " class="img-responsive" />
						<div class="overlay">
							<h4>Department 4</h4>
							<ul class="social_agileinfo">
								<li><a href="#" class="w3_facebook"><i class="fa fa-facebook"></i></a></li>
		...
		<div class="menu_w3ls_agile_top_section">
			...
			<div>
				  <div class="w3_agile_recipe-grid">
								...
								<div class="col-md-6 col-sm-6 tab-image">
									<img src="Patient/images/g5.jpg" alt="Medicinal">
								</div>
			...
			<div>
				  <div class="w3_agile_recipe-grid">
								...
								<div class="col-md-6 col-sm-6 tab-image two">
									<img src="Patient/images/g6.jpg" alt="Medicinal">
								</div>
								<div class="clearfix"></div>
					    </div>
			...
			<div>
			 <div class="w3_agile_recipe-grid">
								...
								<div class="col-md-6 col-sm-6 tab-image">
									<img src="Patient/images/g7.jpg" alt="Medicinal">
								</div>
									<div class="col-md-6 col-sm-6 tab-info">
								<h4>We are having department to us</h4>
									<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting... </p>
...
<script src="Patient/js/JiSlider.js"></script>
		<script>
...
<script src="Patient/js/ziehharmonika.js"></script>
<script>
...
<!-- stats -->
	<script src="Patient/js/jquery.waypoints.min.js"></script>
	<script src="Patient/js/jquery.countup.js"></script>
		<script>
			$('.counter').countUp();
		</script>
<!-- //stats -->
...
<!-- flexSlider -->
	<script defer src="Patient/js/jquery.flexslider.js"></script>
	<script type="text/javascript">
		$(window).load(function(){
...
<script type="text/javascript" src="Patient/js/move-top.js"></script>
<script type="text/javascript" src="Patient/js/easing.js"></script>
<script type="text/javascript">
...
<!-- start-smoth-scrolling -->
			<script src="Patient/js/jarallax.js"></script>
