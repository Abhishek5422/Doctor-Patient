		...
		<div class="agile-signup">	
			...
			<div class="content2">
				...
				<form method="POST">
					...
					<input type="submit" class="register" value="Signup" name=button>
				</form>
...
if(isset($_POST['button']))
{
		...
		$insert="INSERT INTO hospital(Hospital_name,Hospital_phone,Hospital_mail,Hospital_password,Hospital_address) values ('$username','$phone','$Email','$password','$Address')";
		$execute=mysqli_query($connect,$insert);
		if ($execute==1)
		{
			echo"<script>alert('registeration is succesfull')</script>";
